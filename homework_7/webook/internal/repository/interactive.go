...
type InteractiveRepository interface {
	...
	GetTopN(ctx context.Context, biz string, limit int) ([]domain.Interactive, error)
}
...
func (c *CachedInteractiveRepository) GetTopN(ctx context.Context, biz string, limit int) ([]domain.Interactive, error) {
	intrs, err := c.dao.GetTopN(ctx, biz, limit)
	if err != nil {
		return nil, err
	}
	return slice.Map(intrs, func(idx int, src dao.Interactive) domain.Interactive {
