...
type InteractiveDAO interface {
	...
	GetTopN(ctx context.Context, biz string, limit int) ([]Interactive, error)
}
...
func (dao *GORMInteractiveDAO) GetTopN(ctx context.Context, biz string, limit int) ([]Interactive, error) {
	var res []Interactive
	err := dao.db.WithContext(ctx).
		Limit(limit).
		Order("like_cnt").
